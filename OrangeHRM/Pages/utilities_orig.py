...
class UtilitiesScript():
    ...
    # Not working
    ############################################################################
    def selectDropdown1(self,select_dropdown, select_options, option_value):
        select = self.driver.find_element_by_id(select_dropdown)
        select.click()
        selected_options = select.find_elements_by_tag_name(select_options)
